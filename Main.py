...
def write_results_to_docx(filename, prompt, chatgpt_response):
    doc = Document()
    doc.add_heading('ChatGPT Question and Response', level=1)
...
# Main function
def main():
    openai_api_key = "sk-OXNsYNxSDx8kdtQxs9Xn7DrHwvdoYKx2MM8NGmHJp4T3BlbkFJ6X8wkotlK286QP4TUVmaxolwS0suY1gscjajNrWE4A"
